...
var CreateUser = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/user/add",
	Method:   "POST",
...
var User_F1 = func() {
	EditUser.URL = "https://back.fitroom.ru/api/admin/user/edit/" + strconv.Itoa(userResp.ID)
	DeleteUser.URL = "https://back.fitroom.ru/api/admin/user/delete/" + strconv.Itoa(userResp.ID)
}
