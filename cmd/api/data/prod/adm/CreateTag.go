...
var CreateTag = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/tag/add",
	Method:   "POST",
...
var Tag_F1 = func() {
	EditTag.URL = "https://back.fitroom.ru/api/admin/tag/edit/" + strconv.Itoa(tagResp.ID)
	DeleteTag.URL = "https://back.fitroom.ru/api/admin/tag/delete/" + strconv.Itoa(tagResp.ID)
}
