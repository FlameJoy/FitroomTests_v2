...
var CreateComplex = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/complex/add",
	Method:   "POST",
...
func Complex_F1() {
	EditComplex.URL = "https://back.fitroom.ru/api/admin/omplex/edit/" + strconv.Itoa(resp.ID)
	DeleteComplex.URL = "https://back.fitroom.ru/api/admin/complex/delete/" + strconv.Itoa(resp.ID)
}
