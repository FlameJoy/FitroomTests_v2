...
var CreateWorkplace = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/workplace/add",
	Method:   "POST",
...
var WP_F1 = func() {
	EditWorkplace.URL = "https://back.fitroom.ru/api/admin/workplace/edit/" + strconv.Itoa(workplaceResp.ID)
	DeleteWorkplace.URL = "https://back.fitroom.ru/api/admin/workplace/delete/" + strconv.Itoa(workplaceResp.ID)
}
