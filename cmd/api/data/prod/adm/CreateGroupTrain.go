...
var CreateGroupTrain = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/group-training/add",
	Method:   "POST",
...
var GroupTrain_F1 = func() {
	EditGroupTrain.URL = "https://back.fitroom.ru/api/admin/group-training/edit/" + strconv.Itoa(resp.ID)
	DeleteGroupTrain.URL = "https://back.fitroom.ru/api/admin/group-training/delete/" + strconv.Itoa(resp.ID)
}
