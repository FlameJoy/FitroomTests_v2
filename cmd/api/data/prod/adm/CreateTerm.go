...
var CreateTerm = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/term/add",
	Method:   "POST",
...
func Term_F1() {
	EditTerm.URL = "https://back.fitroom.ru/api/admin/term/edit/" + strconv.Itoa(resp.ID)
	DeleteTerm.URL = "https://back.fitroom.ru/api/admin/term/delete/" + strconv.Itoa(resp.ID)
}
