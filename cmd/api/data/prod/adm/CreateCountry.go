...
var CreateCountry = models.Request{
	URL:      "https://back.fitroom.ru/api/admin/country/add",
	Method:   "POST",
...
func Country_F1() {
	EditCountry.URL = "https://back.fitroom.ru/api/admin/country/edit/" + strconv.Itoa(resp.ID)
	DeleteCountry.URL = "https://back.fitroom.ru/api/admin/country/delete/" + strconv.Itoa(resp.ID)
}
