...
var CreatePackage = models.Request{
	URL:      "https://back.fitroom.fun/api/admin/package/add",
	Method:   "POST",
...
var Package_F1 = func() {
	EditPackage.URL = "https://back.fitroom.fun/api/admin/package/edit/" + strconv.Itoa(packageResp.ID)
	DeletePackage.URL = "https://back.fitroom.fun/api/admin/package/delete/" + strconv.Itoa(packageResp.ID)
}
