...
var CreateDistrict = models.Request{
	URL:      "https://back.fitroom.fun/api/admin/district/add",
	Method:   "POST",
...
func District_F1() {
	EditDistrict.URL = "https://back.fitroom.fun/api/admin/district/edit/" + strconv.Itoa(resp.ID)
	DeleteDistrict.URL = "https://back.fitroom.fun/api/admin/district/delete/" + strconv.Itoa(resp.ID)
}
