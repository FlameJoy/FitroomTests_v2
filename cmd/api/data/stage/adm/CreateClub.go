...
var CreateClub = models.Request{
	URL:      "https://back.fitroom.fun/api/admin/club/add",
	Method:   "POST",
...
var Club_F1 = func() {
	EditClub.URL = "https://back.fitroom.fun/api/admin/club/edit/" + strconv.Itoa(clubResp.ID)
	DeleteClub.URL = "https://back.fitroom.fun/api/admin/club/delete/" + strconv.Itoa(clubResp.ID)
}
