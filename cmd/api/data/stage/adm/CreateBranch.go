...
var CreateBranch = models.Request{
	URL:      "https://back.fitroom.fun/api/admin/branch/add",
	Method:   "POST",
...
var Branch_F1 = func() {
	EditBranch.URL = "https://back.fitroom.fun/api/admin/branch/edit/" + strconv.Itoa(branchResp.ID)
	DeleteBranch.URL = "https://back.fitroom.fun/api/admin/branch/delete/" + strconv.Itoa(branchResp.ID)
}
