...
var BonusRefferal = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/3",
	Method:  "PUT",
...
var BonusMaxProcent = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/5",
	Method:  "PUT",
	Auth:    &settings.TokenStage,
...
var BonusMinProcent = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/4",
	Method:  "PUT",
	Auth:    &settings.TokenStage,
...
var BonusDayBeforeDel = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/7",
	Method:  "PUT",
	Auth:    &settings.TokenStage,
...
var BonusDelProcent = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/6",
	Method:  "PUT",
	Auth:    &settings.TokenStage,
...
var BonusAdd = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/1",
	Method:  "PUT",
	Auth:    &settings.TokenStage,
...
var BonusRemove = models.Request{
	URL:     "https://back.fitroom.fun/api/admin/setting/edit/2",
	Method:  "PUT",
	Auth:    &settings.TokenStage,
