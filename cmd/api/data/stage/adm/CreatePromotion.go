...
var CreatePromotion = models.Request{
	URL:      "https://back.fitroom.fun/api/admin/promotion/add",
	Method:   "POST",
...
var Promotion_F1 = func() {
	EditPromotion.URL = "https://back.fitroom.fun/api/admin/promotion/edit/" + strconv.Itoa(promotionResp.ID)
	DeletePromotion.URL = "https://back.fitroom.fun/api/admin/promotion/delete/" + strconv.Itoa(promotionResp.ID)
}
