...
var CreateCity = models.Request{
	URL:      "https://back.fitroom.fun/api/admin/city/add",
	Method:   "POST",
...
func City_F1() {
	EditCity.URL = "https://back.fitroom.fun/api/admin/city/edit/" + strconv.Itoa(resp.ID)
	DeleteCity.URL = "https://back.fitroom.fun/api/admin/city/delete/" + strconv.Itoa(resp.ID)
}
